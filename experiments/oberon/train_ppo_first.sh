...
#SBATCH --output=/scratch2/jliu/Feedback/logs/rlhf/ppo_align_%A_%a.log
#SBATCH --array=0-4
...
REWARDS=("is_acknowledgement","align_lexical_unigram" "align_lexical_bigram" "align_syntactic" "align_semantic")
